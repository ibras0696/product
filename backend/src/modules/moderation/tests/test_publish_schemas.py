    ...
    [
        (
            base(
                "create_entity",
                {
                    "entity": {**ENTITY, "type": "unknown_entity"},
                    "relations": [],
                    "sources": [],
                    "approved_media_ids": [],
                },
        ...
        (
            base(
                "create_relation",
                {
                    "relation": {**RELATION, "type": "unknown_relation"},
                    "sources": [SOURCE],
                },
            ),
            "unknown_relation",
        ...
        (
            base(
                "add_source",
                {
                    "target_type": "entity",
                    "target_id": ID,
                    "source": {**SOURCE, "type": "unknown_source"},
                },
            ),
            "unknown_source",
        ),
...
def test_publish_payload_rejects_unknown_catalog_enum_values(
    document: dict[str, object], invalid_value: str
) -> None:
    with pytest.raises(ValidationError, match=invalid_value):
        TypeAdapter(PublishCommand).validate_python(document)
